...
- `scripts/Battle/GridBattleScene.lua`：30×30 网格战斗场景原型，管理格子、单位占位、点击/按钮格子移动、战斗 HUD 和返回主界面。
...
- 新增 30×30 网格战斗场景原型：`GridBattleScene` 管理战场格子、单位占位、越界/占用校验、按格移动插值；主界面“秘境挑战”进入战斗，战斗内“返回”回到主界面。
...
- 在 `GridBattleScene` 上继续实现寻路、技能范围、AI 行动、攻击结算和战斗结果存档。
