...
- 最近一次 Inspector 修改已将编队页顶部/内容/底部控件再次重排：总战力 left=425/top=119，阵容 TAB left=34/top=124，内容区 width=678、left=16/top=170/right=26/bottom=327，返回按钮 left=1/top=1183，底部按钮组 left=25/top=1113，勇者列表宽度 307，勇者卡片宽度 95%。
