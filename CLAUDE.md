...
- 最近一次 Inspector 修改已将编队页阵容 TAB 容器缩到 373 宽并移到 left=33/top=196，标题移到 left=19/top=66，总战力移到 left=412/top=194，顶部锁定按钮与智能推荐移到底部区域，并删除底部操作外层透明 Panel，把提示文本和按钮组直接挂到 `background` 节点下。
