...
- 勇者动作资源位于 `assets/image/npcClip/0001/` 等 NPC 序列帧目录，主界面森林关卡区 `Hanginglist` 最多显示 5 个已拥有勇者，拥有不足 5 个时只显示实际拥有数量；显示勇者会按状态播放待机 01-04、移动 06-09、攻击 10-14 序列帧，三类动作已统一显示高度，攻击帧使用更宽承载框避免人物变小。
