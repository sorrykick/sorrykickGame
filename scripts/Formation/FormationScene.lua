    ...
    return UI.Panel {
        ...
        children = {
            UI.Panel {
                ...
                borderColor = { 68, 45, 25, 180 },
                borderWidth = 1,
                borderRadius = 12,
            },
            UI.Panel { width = 76, height = 86, position = "absolute", left = 11, top = 9, borderRadius = 0, flexShrink = 0, backgroundImage = HERO_IMAGE, backgroundFit = "contain", imageTint = assigned and { 210, 235, 255, 255 } or { 255, 255, 255, 255 } },
            UI.Panel { width = 30, height = 30, position = "absolute", left = 62, top = 5, backgroundImage = QUALITY_ICON_PATHS[hero.quality] or QUALITY_ICON_PATHS[1], backgroundFit = "contain" },
            CreateStarBadge(hero.star),
            UI.Label { id = "hero_1", text = hero.name, width = 142, height = 26, position = "absolute", left = 98, top = 9, fontSize = 17, fontWeight = "bold", fontColor = { 88, 46, 45, 255 }, maxLines = 1 },
            UI.Label { id = "hero_1", text = hero.job .. " · " .. hero.faction, width = 126, height = 22, position = "absolute", left = 98, top = 38, fontSize = 13, fontColor = { 74, 56, 42, 220 }, maxLines = 1 },
            UI.Label { id = "hero_1", text = "战力 " .. FormatNumber(hero.power), width = 126, height = 24, position = "absolute", left = 98, top = 67, fontSize = 14, fontWeight = "bold", fontColor = { 202, 92, 44, 255 }, maxLines = 1 },
